...
namespace Frano.BehaviourEditor
{
    public class BehaviourEditor : EditorWindow
    {
        ...
        public enum UserActions{addState, addTransitionNode, deleteNode, commentNode, makeTransition, makePortal, resetPan}
        #endregion
            ...
            if(clickedOnWindow)
            {
                if(selectedNode.drawNode is StateNode || selectedNode.drawNode is PortalNode)
                {
                    if(selectedNode.id != transitFromId)
                    {
                        ...
                        BaseNode enterNode = BehaviourEditor.settings.currentGraph.GetNodeWithIndex(transNode.enterNode);
        ...
        void ContextCallback(object o)
        {
            ...
            switch (a)
            {
                ...
                case UserActions.makePortal:
                    settings.AddNodeOnGraph(settings.portalNode, 100, 50, "Portal", mousePosition);
                    break;
