...
Shader "Slowarea"
{
	...
	SubShader
	{
		...
		{
			float4 color2 = IsGammaSpace() ? float4(1,0.8720647,0,0) : float4(1,0.7332604,0,0);
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 ase_worldNormal = i.worldNormal;
			float fresnelNdotV1 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode1 = ( 0.0 + 2.18 * pow( 1.0 - fresnelNdotV1, 5.0 ) );
...
/*ASEBEGIN
Version=18900
1536;-281;1920;1019;1181.85;455.8208;1;True;True
Node;AmplifyShaderEditor.ColorNode;2;-616.8499,-107.8208;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;1,0.8720647,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;1;-633.8499,231.1792;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;2.18;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;-333.8499,50.17923;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=2018486D6747C8C261132AE2390C32E33D02468D